...
#t_0 = 1:56:50
#t_f = 1:57:10
eclipse_mp4 = "Eclipse Stream Analysis/2024 April 8, 4k Live Stream of the Solar Eclipse from the UCA Observatory [lrWkmZvI3JY].mp4"
start_time = "01:56:50"
end_time = "01:57:10"
...
(
    ...
    .output('frame%d.png',vframes = 1)# extracts frames from the entire video at 1 fps and saves them as pngs
    .run()
)